  ...
  <div
    ...
    <figure class="relative group">
      ...
      <div class="carousel w-full h-56 bg-neutral">
        <div v-for="(image, index) in server.images" :key="index"
          class="absolute inset-0 transition-opacity duration-500 ease-in-out" :class="server.currentSlide === index
              ? 'opacity-100 z-10'
              : 'opacity-0 z-0'
            ">
        ...
        <div v-if="server.images.length > 1"
    ...
    <div class="card-body p-5">
      <h2 class="card-title text-xl font-bold flex justify-between items-center">
      ...
      <div class="card-actions justify-between items-center mt-4 pt-4 border-t border-base-200">
        <button v-if="server.status == 'Online'" @click="openModal(server.id)"
        ...
        <dialog :id="'connect_modal_' + server.id" class="modal">
          <div class="modal-box">
            ...
            <div class="bg-base-200 p-3 rounded-lg font-mono text-sm flex justify-between items-center">
